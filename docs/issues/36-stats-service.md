# Issue 36: [STATS] Crear StatsService con métricas agregadas

## Objetivo
Crear un servicio de estadísticas que calcule métricas en tiempo real consultando las entidades
existentes. No requiere nueva tabla en BD, solo queries de agregación.

## Archivo a crear
`src/main/java/com/promptvault/service/StatsService.java`
...
## Dependencias
- Issue 37 (DTOs) debe estar completado primero
- Issue 38 (queries en repositories) debe estar completado primero

## Verificación
```bash
# Al arrancar la aplicación no deben aparecer errores de compilación
mvn clean compile
```
